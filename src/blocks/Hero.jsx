...
export default function Hero({ heading, text, backgroundImage }) {
  ...
  return (
    <div className='relative overflow-hidden'>
        ...
        <Image className='absolute inset-0 object-cover' src={backgroundImage.url} width={backgroundImage.width} height={backgroundImage.height} alt={backgroundImage.alt}/>
    </div>
  )
}
