...
const HeaderBanner = ({ HeaderBannerData }: HeaderBannerProps) => {
  return (
    <div className="bg-primary container rounded-md md:py-12 py-20  text-white  relative overflow-hidden">
      ...
      <div className="absolute rounded-full bg-secondary opacity-30 w-10 h-10 lg:w-12 lg:h-12 md:top-4 md:right-8 top-28 right-6  flex items-end justify-center text-white p-4"></div>
      ...
      <div className="absolute rounded-full bg-secondary opacity-30  md:w-10 md:h-10 md:top-24 md:left-36 flex items-end justify-center text-white"></div>
    </div>
  );
};
